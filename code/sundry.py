...
df_prev=pd.read_csv(r'c:\Users\dm.maksymenko\Python\AOEngine_bind\data\loads\concated_plus_60.csv',sep=';')
...
df_conc.to_csv(r'c:\Users\dm.maksymenko\Python\AOEngine_bind\data\loads\concated_plus_80.csv',index=False,sep=';')
